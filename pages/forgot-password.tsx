...
const useStyles = (theme: Theme): ForgotPasswordStyle => ({
    background: {
        width: "100%",
        height: "100%",
...
const ForgotPassword: React.FC = (props) => {
    const classes = useClasses(useStyles, { name: "forgotPasswordStyles" }) as ForgotPasswordStyle;
    ...
    return (
        <React.Fragment>
            <Head>
                <title>
                    {PLATFORM_NAME} | {languageData?.ForgotPassword}
                </title>
            </Head>
