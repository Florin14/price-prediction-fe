...
export interface LegalEntitiesPropStyles {
    tableContainer: any;
...
const LegalEntitiesComponentStyles = (_theme: any): LegalEntitiesPropStyles => ({
...
export default LegalEntitiesComponentStyles;